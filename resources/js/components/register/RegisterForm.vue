    ...
    <form method="post" @submit.prevent="register">
        ...
        <div class="form-group" :class="{'has-error': errors.has('name')}">
            ...
            <input v-model="name"
                   ...
                   class="form-control"
                   data-vv-as="用户名"
                   id="name" type="text" placeholder="用户名唯一英文或数字组合" name="name" required="required" autofocus="autofocus">
        ...
        <div class="form-group user-register-tooltip" :class="{'has-error': errors.has('email')}">
            ...
            <input v-model="email"
                   ...
                   data-vv-as="邮箱"
                   id="email" type="email" name="email" placeholder="请不要随意填测试邮箱" value="" required="required" class="form-control">
        ...
        <div class="form-group buttons">
            <p>
                注册时请您一定要阅读
                <a href="/agreement" target="_blank" rel="noreferrer noopener" style="text-align: left;">ITJZ服务条款和版权声明 </a>
            </p>
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <a href="/auth/github"><i class="fa fa-github"></i> 使用 Github 登录</a>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <a href="/auth/weibo" class="pull-right"><i class="fa fa-weibo"></i> 使用微博登录</a>
                </div>
            </div>
        </div>
    </form>
